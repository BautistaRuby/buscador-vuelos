...
# Cargar credenciales de Amadeus
amadeus = Client(
    client_id="e6Qp0cefmeUH4IGAGXtL7XPrhCYD3E9Y", #Tienes que poner tu propia ID de API
    client_secret="9kTvmKGJKi5z3ZVp" #Tienes que poner tu propia contraseña 
)
